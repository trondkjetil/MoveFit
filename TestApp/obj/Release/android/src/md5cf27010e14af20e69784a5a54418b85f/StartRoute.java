...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TestApp.StartRoute, TestApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", StartRoute.class, __md_methods);
	}


	public StartRoute () throws java.lang.Throwable
	{
		super ();
		if (getClass () == StartRoute.class)
			mono.android.TypeManager.Activate ("TestApp.StartRoute, TestApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
