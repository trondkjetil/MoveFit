...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TestApp.LocationServiceConnection, moveFit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", LocationServiceConnection.class, __md_methods);
	}
	...
	public LocationServiceConnection () throws java.lang.Throwable
	{
		...
		if (getClass () == LocationServiceConnection.class)
			mono.android.TypeManager.Activate ("TestApp.LocationServiceConnection, moveFit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public LocationServiceConnection (md566e9d4633adee2394374d4367e76a5cb.LocationServiceBinder p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == LocationServiceConnection.class)
			mono.android.TypeManager.Activate ("TestApp.LocationServiceConnection, moveFit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "TestApp.LocationServiceBinder, moveFit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
