...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TestApp.StepCounter2, TestApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", StepCounter2.class, __md_methods);
	}


	public StepCounter2 () throws java.lang.Throwable
	{
		super ();
		if (getClass () == StepCounter2.class)
			mono.android.TypeManager.Activate ("TestApp.StepCounter2, TestApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
