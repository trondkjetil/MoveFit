...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TestApp.StepCounter, TestApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", StepCounter.class, __md_methods);
	}


	public StepCounter () throws java.lang.Throwable
	{
		super ();
		if (getClass () == StepCounter.class)
			mono.android.TypeManager.Activate ("TestApp.StepCounter, TestApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
