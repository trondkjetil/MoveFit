...
namespace TestApp
{
    ...
    public class RouteListFragment : Fragment
    {
        ...
        {
            var view = inflater.Inflate(Resource.Layout.routesNearbyRecycleView, container, false);

           
            mRecyclerView = view.FindViewById<RecyclerView>(Resource.Id.recycleNearbyRoutes);
            ...
            {
                TextView txt = view.FindViewById<TextView>(Resource.Id.emptyRouteNearby);
